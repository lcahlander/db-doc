...
import module namespace app="http://docbook.org/apps/doc/templates" at "app.xql";
import module namespace db-template="http://docbook.org/templates" at "db-template.xqm";
